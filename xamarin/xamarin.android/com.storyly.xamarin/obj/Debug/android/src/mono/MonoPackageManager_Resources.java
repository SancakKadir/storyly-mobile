...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "com.storyly.xamarin.dll" comes first in this list. */
		"com.storyly.xamarin.dll",
		"Jsr305Binding.dll",
		"storyly.xamarin.binding.dll",
		"Xamarin.Android.Glide.DiskLruCache.dll",
		"Xamarin.Android.Glide.dll",
		"Xamarin.Android.Glide.GifDecoder.dll",
		"Xamarin.Android.JetBrains.KotlinXSerializationJson.dll",
		...
		"Xamarin.Chromium.CroNet.Api.dll",
		...
		"Xamarin.GooglePlayServices.CroNet.dll",
		"Xamarin.GooglePlayServices.Tasks.dll",
		"Xamarin.Jetbrains.Annotations.dll",
		"Xamarin.JetBrains.KotlinXSerializationCoreJvm.dll",
		"Xamarin.JetBrains.KotlinXSerializationJsonJvm.dll",
