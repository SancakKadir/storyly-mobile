...
namespace Com.Appsamurai.Storyly {
	...
	public sealed partial class StoryPollComponent : global::Com.Appsamurai.Storyly.StoryComponent {
		...
		public unsafe StoryPollComponent (string id, string title, global::System.Collections.Generic.IList<string> options, int selectedOptionIndex, string customPayload) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
